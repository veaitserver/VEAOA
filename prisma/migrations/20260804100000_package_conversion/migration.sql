...
CREATE TABLE "new_CoursePackage" (
    ...
    "signingType" TEXT NOT NULL DEFAULT 'NEW_SIGN',
    "classType" TEXT NOT NULL DEFAULT 'ONE_ON_ONE',
    ...
    CONSTRAINT "CoursePackage_convertedFromId_fkey" FOREIGN KEY ("convertedFromId") REFERENCES "CoursePackage" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_CoursePackage" ("classType", "confirmedAt", "confirmedById", "createdAt", "createdById", "financeConfirmedAt", "financeConfirmedById", "gradeId", "id", "notes", "pricePerHour", "remainingHours", "signingType", "status", "studentId", "subjectId", "totalAmount", "totalHours") SELECT "classType", "confirmedAt", "confirmedById", "createdAt", "createdById", "financeConfirmedAt", "financeConfirmedById", "gradeId", "id", "notes", "pricePerHour", "remainingHours", "signingType", "status", "studentId", "subjectId", "totalAmount", "totalHours" FROM "CoursePackage";
DROP TABLE "CoursePackage";
ALTER TABLE "new_CoursePackage" RENAME TO "CoursePackage";
CREATE UNIQUE INDEX "CoursePackage_convertedFromId_key" ON "CoursePackage"("convertedFromId");
